...
const DonHang = () => {
  ...
  const danhSachMonAn = [
  { tenMon: 'Phở bò', donGia: 35000 },
    { tenMon: 'Bánh mì', donGia: 20000 },
    { tenMon: 'Cơm tấm', donGia: 40000 },
    { tenMon: 'Bún chả', donGia: 30000 },
    { tenMon: 'Hủ tiếu', donGia: 32000 },
    { tenMon: 'Mì xào', donGia: 28000 },
    { tenMon: 'Gỏi cuốn', donGia: 15000 },
    { tenMon: 'Chả giò', donGia: 18000 },
    { tenMon: 'Bánh cuốn', donGia: 25000 },
    { tenMon: 'Xôi mặn', donGia: 22000 },
];
...
const tinhTongTien = (monAnList) => {
 ...
 const donMoi = monAnDaChon.map(mon => ({
  ...
  const filteredOrders = orders.filter(order => {
    ...
    return (
      (filterSoBan === '' || order.soBan === filterSoBan) &&
...
<div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4">
        ...
        <input type="text" readOnly placeholder="Món ăn" value={monAn} onChange={(e) => setMonAn(e.target.value)} className="border rounded px-3 py-2" />
        <input type="number" min={1} placeholder="Số lượng" value={soLuong} onChange={(e) => setSoLuong(e.target.value)} className="border rounded px-3 py-2 text-gray-400" />
        <select value={trangThai} onChange={(e) => setTrangThai(e.target.value)} className="border rounded px-3 py-2 text-gray-400">
