...
import { BarChart2, Menu,SquareMenu,Settings, ConciergeBell,TableProperties, BookOpenCheckIcon, UtensilsCrossed } from "lucide-react";
...
const SIDEBAR_ITEMS = [
	...
	{ name: "Quản lý bếp", icon: UtensilsCrossed, color: "#6EE7B7", href: "/kitchen" },
